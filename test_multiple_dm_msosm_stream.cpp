...
int main(int argc, char *argv[])
{
    ...
    const struct option long_options[] = {
        ...
        {"trial", required_argument, nullptr, 'c'},
        {nullptr, 0, nullptr, 0}};
    ...
    MSOSM_GPU_DM_BATCH_stream *msosm[endDM - startDM + 1];
    ...
    for (int i = startDM; i <= endDM; i++)
    {
        ...
        int index = i - startDM;
        msosm[index] = new MSOSM_GPU_DM_BATCH_stream(bw_i, DM_i, f0_i, numDMs);
        msosm[index]->initialize_uint16(fftpoint, count);
        unsigned long M = msosm[index]->M_stream;
